...
class RLController(SumoEnv):
    ...
    def _get_current_observation(self):
        ...
        norm_flow_lane_0_bottleneck = np.clip(self.processed_flow_lane_0_merging_vph / (self.MAX_LANE_FLOW_VPH if self.MAX_LANE_FLOW_VPH > 0 else 1.0), 0, 1)
        norm_flow_lane_0_upstream = np.clip(self.processed_flow_lane_0_upstream_vph / (self.MAX_LANE_FLOW_VPH if self.MAX_LANE_FLOW_VPH > 0 else 1.0), 0, 1)
